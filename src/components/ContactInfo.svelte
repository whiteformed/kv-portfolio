<script>
	...
	const LINKS_LIST = [
		{ href: 'https://t.me/karl0va', text: 'telegram' },
		{ href: 'mailto:karlowa.valeria@yandex.ru', text: 'karlowa.valeria@yandex.ru' },
		{ href: 'https://disk.yandex.ru/i/QsyJ7kCFJROLSA', text: '🔗 CV' },
	];
</script>
